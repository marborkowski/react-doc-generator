...
export default (function Command () {
  ...
  Commander
	...
	.option('-f, --format <format>', 'Output format (markdown|asciiddoc) [markdown]')
    .option('-t, --title [value]', 'Document title. Default: \'Components\'', 'Components')
    .option('-o, --output <file>', 'Markdown file to write. Default: \'DOCUMENTATION.MD\'')
	.option('--handlebar-template [path]', 'Handlebar output template')
    .parse(process.argv);
